class Bola {
    ...
    interseccioSegmentRectangle(segment, rectangle) {
        ...
        puntII = segment.puntInterseccio(segmentVoraSuperior);
        puntIII = segment.puntInterseccio(segmentVoraSuperior);
        puntIV = segment.puntInterseccio(segmentVoraSuperior);
